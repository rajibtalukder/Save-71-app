...
//
//     final nearestProductsModel = nearestProductsModelFromJson(jsonString);

import 'dart:convert';

NearestProductsModel nearestProductsModelFromJson(String str) => NearestProductsModel.fromJson(json.decode(str));

String nearestProductsModelToJson(NearestProductsModel data) => json.encode(data.toJson());

class NearestProductsModel {
  bool? status;
  String? message;
  String? currencyCode;
  double? currRate;
  ...
  factory NearestProductsModel.fromJson(Map<String, dynamic> json) => NearestProductsModel(
    status: json["status"],
