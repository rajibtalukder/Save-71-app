...
class PopularProductsModel {
  ...
  List<ExtraCat>? popularProductsModelExtraCat;
  ...
  PopularProductsModel({
     ...
     this.mainCat,
     this.extraCat,
     this.popularProductsModelExtraCat,
     this.allExtraCat,
     this.allCat,
     this.shops,
     this.shopType,
  ...
  factory PopularProductsModel.fromJson(Map<String, dynamic> json) => PopularProductsModel(
    ...
    popularProductsModelExtraCat: List<ExtraCat>.from(json["extra_cat"].map((x) => ExtraCat.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "extra_cat": List<dynamic>.from(popularProductsModelExtraCat!.map((x) => x.toJson())),
