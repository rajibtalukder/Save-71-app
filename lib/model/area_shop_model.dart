...
//
//     final areaShopModel = areaShopModelFromJson(jsonString);

import 'dart:convert';

AreaShopModel areaShopModelFromJson(String str) => AreaShopModel.fromJson(json.decode(str));

String areaShopModelToJson(AreaShopModel data) => json.encode(data.toJson());
...
class AreaShopModel {
  ...
  factory AreaShopModel.fromJson(Map<String, dynamic> json) => AreaShopModel(
    status: json["status"],
