...
//
//     final popularManufacturerModel = popularManufacturerModelFromJson(jsonString);

import 'dart:convert';

PopularManufacturerModel popularManufacturerModelFromJson(String str) => PopularManufacturerModel.fromJson(json.decode(str));

String popularManufacturerModelToJson(PopularManufacturerModel data) => json.encode(data.toJson());

class PopularManufacturerModel {
  bool? status;
  String? message;
  ...
  List<ExtraCat>? popularManufacturerModelExtraCat;
  List<ExtraCat>? allExtraCat;
  List<AllCat>? allCat;
  List<Shop>? shops;
  int? shopType;

  PopularManufacturerModel({
     this.status,
     this.message,
     this.sortedShops,
     this.currRate,
     ...
     this.mainCat,
     this.extraCat,
     this.popularManufacturerModelExtraCat,
     this.allExtraCat,
     this.allCat,
     this.shops,
     this.shopType,
  ...
  factory PopularManufacturerModel.fromJson(Map<String, dynamic> json) => PopularManufacturerModel(
    status: json["status"],
    message: json["message"],
    sortedShops: List<Shop>.from(json["sortedShops"].map((x) => Shop.fromJson(x))),
    ...
    popularManufacturerModelExtraCat: List<ExtraCat>.from(json["extra_cat"].map((x) => ExtraCat.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "extra_cat": List<dynamic>.from(popularManufacturerModelExtraCat!.map((x) => x.toJson())),
