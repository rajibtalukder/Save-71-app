...
Widget homePopularManufacturerItem(ExtraCat popularManufacturer) {
  return GestureDetector(
    onTap: () async {
      Get.to(const ItemDetailsScreen());
      await authController.getProductDetails(popularManufacturer.toString());
    },
    child: Container(
      height: 250.h,
      width: 145.w,
        ...
        children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(popularManufacturer.extraCatImageUrl),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Container(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                subTitleText(popularManufacturer.extraCatName,
                    size: 12, fontWeight: FontWeight.w500),
                subTitleText(
                    '${popularManufacturer.extraCatDeductAmount.toStringAsFixed(2)} BDT',
                    size: 12,
