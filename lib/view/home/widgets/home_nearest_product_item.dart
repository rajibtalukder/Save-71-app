...
Widget homeNearestProductItem(Product nearestProducts) {
  return GestureDetector(
    onTap: () async {
      Get.to(const ItemDetailsScreen());
     await authController.getProductDetails(nearestProducts.productId.toString());
        ...
        children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(nearestProducts.extraCatImageUrl),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Container(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                subTitleText(nearestProducts.productName,
                    size: 12, fontWeight: FontWeight.w500),
                subTitleText(
                    '${nearestProducts.productPrice.toStringAsFixed(2)} BDT',
                    size: 12,
