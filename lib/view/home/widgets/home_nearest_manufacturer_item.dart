...
Widget homeNearestManufacturerItem(Product nearestManufacturer) {
  return GestureDetector(
    onTap: () async {
      Get.to(const ItemDetailsScreen());
      await authController.getProductDetails(nearestManufacturer.productId.toString());
    },
    child: Container(
      height: 250.h,
      width: 145.w,
        ...
        children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(nearestManufacturer.extraCatImageUrl),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Container(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                subTitleText(nearestManufacturer.productName,
                    size: 12, fontWeight: FontWeight.w500),
                subTitleText(
                    '${nearestManufacturer.productPrice.toStringAsFixed(2)} BDT',
                    size: 12,
